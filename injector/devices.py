...
DEVICES = [
    ...
    Device(
        ...
        'Infinix Hot 60 Pro+',
        {
            ...
            'force_green_state': PatchStage(
                'force_green_state',
                pattern='c8 03 00 d0 00 c9 4d b9 c0 03 5f d6',
                replacement='c8 03 00 d0 1f 29 0d b9 c0 03 5f d6',
                match_mode=MatchMode.ALL,
                description='Force boot state to always be set to green',
            ),
            'patch_green_state': PatchStage(
                'patch_green_state',
                pattern='c8 03 00 d0 00 c9 0d b9 c0 03 5f d6',
                replacement='c8 03 00 d0 1f 29 0d b9 c0 03 5f d6',
                match_mode=MatchMode.ALL,
                description='Additional green state value',
            ),
            'verified_boot_state': PatchStage(
                'verified_boot_state',
                pattern='c8 03 00 d0 08 c9 8d b9',
                replacement='c8 03 00 d0 08 29 8d b9',
                match_mode=MatchMode.ALL,
                description='Force verified.boot.state to green',
            ),
            'remove_orange_state': PatchStage(
                'remove_orange_state',
                pattern='fd 7b be a9 f3 0b 00 f9 fd 03 00 91 c8 03 00 d0 08 c9 4d b9',
                replacement='fd 7b be a9 f3 0b 00 f9 fd 03 00 91 c8 03 00 d0 08 29 4d b9',
                match_mode=MatchMode.ALL,
                description='Remove orange state on boot screen',
            ),
            'bypass_security_control': PatchStage(
            ...
            'avb_allow_verification_error': PatchStage(
                'avb_allow_verification_error',
                pattern='e1 03 14 2a 3f 4d 00 94 74 01 00 35 36 00 80 52',
                replacement='e1 03 14 2a 3f 4d 00 94 1f 20 03 d5 36 00 80 52',
                match_mode=MatchMode.ALL,
                description='Force AVB_SLOT_VERIFY_FLAGS_ALLOW_VERIFICATION_ERROR',
            ),
            'patch_avb_allow_error': PatchStage(
                'patch_avb_allow_error',
                pattern='e1 03 15 2a f1 4b 00 94 35 01 00 35 41 ff ff 17',
                replacement='e1 03 15 2a f1 4b 00 94 1f 20 03 d5 41 ff ff 17',
                match_mode=MatchMode.ALL,
                description='Force AVB_SLOT_VERIFY_FLAGS_ALLOW_ERROR',
            ),
